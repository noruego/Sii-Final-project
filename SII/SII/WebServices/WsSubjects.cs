    ...
    class WsSubjects
    {
        ...
        public  async Task<Boolean> delete(int idGroup)
        {
            ...
            try
            {
                ...
                httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Basic", authHeaderValue);
                //var resp = await httpClient.GetAsync("SIIWS_PATM/api/wslista/getlista/" + Settings.idStudent + "/" + Settings.token);
                var resp = await httpClient.DeleteAsync("/SIIWS_PATM/api/wslista/deletelista/" + idGroup + "/" + Settings.idStudent + "/" + Settings.token);
        ...
        public async Task<Boolean> putSubjects(Group gr)
        {
            ...
            try
            {
                ...
                sub.student.idstudent = Int32.Parse(Settings.idStudent);
                sub.group = gr;
